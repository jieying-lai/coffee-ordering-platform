...
<nav>
  ...
  <ul class="nav-links">
    ...
    <li>
      <a href="index.php" class="active">Offers ▾</a>
      <div class="dropdown">
        <a href="index.php#drinks">Drink Offers</a>
        <a href="index.php#food">Food Offers</a>
        <a href="index.php#partners">Partner Promotions</a>
      </div>
    </li>
    <li>
