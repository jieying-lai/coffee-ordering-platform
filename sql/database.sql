...
--
-- Table structure for table `activities_photos`
--

DROP TABLE IF EXISTS `activities_photos`;
CREATE TABLE IF NOT EXISTS `activities_photos` (
...
--
-- Table structure for table `activities_posts`
--

DROP TABLE IF EXISTS `activities_posts`;
CREATE TABLE IF NOT EXISTS `activities_posts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `category` enum('event','promotion','workshop','daily','announcement') NOT NULL DEFAULT 'event',
...
--
-- Dumping data for table `activities_posts`
--
...
(6, 'Barista Milk Steaming & Latte Art Masterclass', 'workshop', 'Ever wanted to pour your own heart or tulip latte art? Our masterclass covers milk temperature control, micro-foam texturing, and pour angles. Beginners welcome, and all materials are provided!', '2026-08-08 18:24:19', 0),
(7, 'Behind the Beans: Fresh Batch of Colombia Pink Bourbon', 'daily', 'Today on the roast bar, our head roaster sampled a fresh micro-lot batch of Colombia Pink Bourbon. Expect vibrant tasting notes of white peach, floral jasmine, and honey sweetness. Available at the slow bar all week long.', '2026-08-06 18:24:19', 0),
(8, '100% Biodegradable & Compostable Takeaway Packaging Introduced', 'announcement', 'As part of our commitment to sustainability, all Cozy Coffee Co. takeaway cups, lids, and straws are now 100% plant-based and commercially compostable. Plus, bring your own tumbler to receive +10 bonus Cozy Points!', '2026-08-04 18:24:19', 0),
(9, 'Community Latte Art Throwdown 2026 Finals', 'event', 'What an incredible night! Over 30 local baristas showcased their pouring skills in our friendly annual Throwdown. Congratulations to all participants for pushing the coffee craft forward!', '2026-08-02 18:24:19', 0),
...
--
-- Constraints for table `activities_photos`
--
